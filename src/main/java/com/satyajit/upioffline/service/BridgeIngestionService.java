 ...
 *   3. Velocity check — reject if sender is submitting too fast (our addition)
 *   4. Decrypt
...
public class BridgeIngestionService {
    ...
    public IngestResult ingest(MeshPacket packet, String bridgeNodeId, int hopCount) {
        try {
            ...
            // step 2 — decrypt to get sender identity for velocity check
            ...
            // step 3 — velocity check (our addition)
